...
namespace AccountServer.Network.Cryptography
{
    public unsafe class AuthCryptography
    {
        ...
        private static byte[] _cryptKey1 = new byte[0x100];
        private static byte[] _cryptKey2 = new byte[0x100];
        private static byte[] _cryptKey3 = new byte[0x100];
        private static byte[] _cryptKey4 = new byte[0x100];
